...
<script setup>
/**
 * 篮球操作记录（对应 RecordActivity，横屏，纯本地 GreenDAO）
 * 3 Tab：全部 / 得分(type 6/7/8) / 犯规(type 9)
 * 删除仅本地软删除（disable=1），不调 API
 * 关联 Member/GameSection 取名字（对应 @ToOne）
 */
import { ref } from 'vue'
...
/** 小节开始/结束/换人 隐藏删除（对应 RecordAdapter 逻辑） */
