  ...
  setup(__props) {
    ...
    function logToFile(msg2) {
      try {
        ...
        formatAppLog("log", "at pages/live/push.nvue:199", "logToFile err: " + e);
      }
    }
    onLoad((opt) => {
      ...
      formatAppLog("log", "at pages/live/push.nvue:212", "[push] publishUrl=", publishUrl.value, "gameId=", gameId.value);
    ...
    onReady(() => {
      ensurePermissions().then((granted) => {
        formatAppLog("log", "at pages/live/push.nvue:240", "[push] permissions granted=", granted, "pusher=", pusher.value);
        ...
        const tryPreview = () => {
          if (pusher.value) {
            formatAppLog("log", "at pages/live/push.nvue:251", "[push] startPreview 调用");
            ...
            formatAppLog("log", "at pages/live/push.nvue:261", "[push] pusher ref 始终为 null -- livepusherview 组件未注册/未挂载");
    ...
    function onState(e) {
      const d = e.detail || {};
      formatAppLog("log", "at pages/live/push.nvue:448", "[pusher] state", d);
        ...
        createElementVNode("view", { class: "live-push" }, [
          ...
          createElementVNode("view", { class: "preview-layer" }, [
            createElementVNode("view", { class: "pv-top-left" }, [
              leagueLogo.value ? (openBlock(), createElementBlock("u-image", {
                key: 0,
                class: "pv-league-logo",
                src: leagueLogo.value,
                mode: "aspectFill"
              }, null, 8, ["src"])) : createCommentVNode("", true),
              createElementVNode("u-text", { class: "pv-league-name" }, toDisplayString(leagueName.value), 1)
            ]),
            ...
            showScore.value ? (openBlock(), createElementBlock("view", {
              key: 0,
              ...
              createElementVNode("view", { class: "pv-scorebar" }, [
                ...
                homeLogo.value ? (openBlock(), createElementBlock("u-image", {
                  key: 0,
                ...
                createElementVNode("view", { class: "pv-cell pv-name-cell" }, [
                  createElementVNode("u-text", { class: "pv-team-name" }, toDisplayString(homeName.value), 1)
                ]),
                createElementVNode("view", { class: "pv-cell pv-score-cell" }, [
                  createElementVNode("u-text", { class: "pv-score" }, toDisplayString(hostScore.value), 1),
                  createElementVNode("u-image", {
                    class: "pv-foul",
                    src: foulHostImg.value,
                    mode: "scaleToFill"
                  }, null, 8, ["src"])
                ]),
                createElementVNode("view", { class: "pv-cell pv-sec-cell" }, [
                  section.value ? (openBlock(), createElementBlock("u-text", {
                    key: 0,
                    class: "pv-section-text"
                  }, toDisplayString(section.value), 1)) : createCommentVNode("", true)
                ]),
                createElementVNode("view", { class: "pv-cell pv-score-cell" }, [
                  createElementVNode("u-text", { class: "pv-score" }, toDisplayString(guestScore.value), 1),
                  createElementVNode("u-image", {
                    class: "pv-foul",
                    src: foulGuestImg.value,
                    mode: "scaleToFill"
                  }, null, 8, ["src"])
                ]),
                createElementVNode("view", { class: "pv-cell pv-name-cell" }, [
                  createElementVNode("u-text", { class: "pv-team-name" }, toDisplayString(guestName.value), 1)
                ]),
                guestLogo.value ? (openBlock(), createElementBlock("u-image", {
                  key: 1,
              ...
              createElementVNode("view", { class: "pv-sub-row" }, [
                createElementVNode("u-text", { class: "pv-sub-text" }, toDisplayString(leagueStageName.value), 1)
              ])
            ])) : createCommentVNode("", true),
            sectionEnd.value ? (openBlock(), createElementBlock("view", {
              key: 1,
              ...
              createElementVNode("view", { class: "pv-se-banner" }, [
                ...
                createElementVNode("view", { class: "pv-se-content" }, [
                  createElementVNode("u-text", { class: "pv-se-league" }, toDisplayString(leagueName.value), 1),
                  createElementVNode("view", { class: "pv-se-row" }, [
                    createElementVNode("u-text", { class: "pv-se-name pv-se-name-left" }, toDisplayString(homeName.value), 1),
                    createElementVNode("u-text", { class: "pv-se-score" }, toDisplayString(hostScore.value) + " : " + toDisplayString(guestScore.value), 1),
                    createElementVNode("u-text", { class: "pv-se-name pv-se-name-right" }, toDisplayString(guestName.value), 1)
                  ]),
                  section.value ? (openBlock(), createElementBlock("u-text", {
                    key: 0,
                    class: "pv-se-section"
              ...
              createElementVNode("view", { class: "pv-se-stats" }, [
                ...
                createElementVNode("view", { class: "pv-se-col" }, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(hostMembers2.value.slice(0, 6), (m, i) => {
                    return openBlock(), createElementBlock("view", {
                      key: "h" + i,
                      class: "pv-se-tr"
                    }, [
                      createElementVNode("u-text", { class: "pv-se-td pv-se-td-name" }, toDisplayString(m.number) + " " + toDisplayString(m.name), 1),
                      createElementVNode("u-text", { class: "pv-se-td" }, toDisplayString(m.score || 0), 1),
                      createElementVNode("u-text", { class: "pv-se-td" }, toDisplayString(m.assists || 0), 1),
                      createElementVNode("u-text", { class: "pv-se-td" }, toDisplayString(m.backboard || 0), 1)
                    ]);
                  }), 128))
                ]),
                createElementVNode("view", { class: "pv-se-col" }, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(guestMembers2.value.slice(0, 6), (m, i) => {
                    return openBlock(), createElementBlock("view", {
                      key: "g" + i,
                      class: "pv-se-tr"
                    }, [
            ...
            msg.value && msg.value !== "小节结束" ? (openBlock(), createElementBlock("view", {
              key: 2,
              class: "pv-msg"
            }, [
              createElementVNode("u-text", { class: "pv-msg-text" }, toDisplayString(msg.value), 1)
            ])) : createCommentVNode("", true)
          ]),
