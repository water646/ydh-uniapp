            ...
            sectionEnd.value ? (openBlock(), createElementBlock("view", {
              ...
              createElementVNode("view", { class: "pv-se-banner" }, [
                ...
                createElementVNode("view", { class: "pv-se-content" }, [
                  ...
                  createElementVNode("view", { class: "pv-se-row" }, [
                    ...
                    createElementVNode("u-text", { class: "pv-se-score pv-se-score-left" }, toDisplayString(hostScore.value), 1),
                    section.value ? (openBlock(), createElementBlock("u-text", {
                      key: 0,
                      class: "pv-se-section"
                    }, toDisplayString(section.value), 1)) : createCommentVNode("", true),
                    createElementVNode("u-text", { class: "pv-se-score pv-se-score-right" }, toDisplayString(guestScore.value), 1),
              ...
              createElementVNode("view", { class: "pv-se-stats" }, [
                ...
                createElementVNode("view", { class: "pv-se-col" }, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(pvHostMembers.value, (m, i) => {
                ...
                createElementVNode("view", { class: "pv-se-col" }, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(pvGuestMembers.value, (m, i) => {
                    return openBlock(), createElementBlock("view", {
                      key: "g" + i,
                      class: "pv-se-tr"
                    }, [
            ...
            createElementVNode("view", { class: "bottom" }, [
              createElementVNode("view", { class: "bottom-row" }, [
                createElementVNode("u-text", {
                  class: "gray-btn",
                  onClick: startPush
                }, toDisplayString(pushing.value ? "直播中" : "开始直播"), 1),
                createElementVNode("u-text", {
                  class: "gray-btn",
                  onClick: stopPush
                }, "结束直播")
